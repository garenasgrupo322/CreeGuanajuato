...
namespace CreeGuanajuato.Controllers
{
    ...
    [ApiController]
    public class EscolaridadsController : ControllerBase
    {
        private readonly CreeGuanajuatoContext _context;

        public EscolaridadsController(CreeGuanajuatoContext context)
        {
            _context = context;
        }

        // GET: api/Escolaridads
        [HttpGet]
