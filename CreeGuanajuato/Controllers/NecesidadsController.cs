...
namespace CreeGuanajuato.Controllers
{
    ...
    [ApiController]
    public class NecesidadsController : ControllerBase
    {
        private readonly CreeGuanajuatoContext _context;

        public NecesidadsController(CreeGuanajuatoContext context)
        {
            _context = context;
        }
